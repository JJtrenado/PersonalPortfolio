let indice = 1;
let slide1 = document.getElementsByClassName('miSlider1');
let slide2 = document.getElementsByClassName('miSlider2');

muestraSlides(indice, slide1);
muestraSlides(indice, slide2);

function avanzaSlide(n){
    muestraSlides( indice+=n, slide1);
    muestraSlides( indice+=n, slide2);
}

setInterval(function tiempo(){
    muestraSlides(indice+=1, slide1)
    muestraSlides(indice+=1, slide2)
},3000);
